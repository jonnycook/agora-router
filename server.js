...
var OPEN, WebSocketServer, addDownServer, app, bodyParser, cbsForUser, connection, downServers, env, express, gatewayByUserId, gatewayForUser, gatewayMessage, gatewayServers, mysql, removeDownServer, request, send, serverId, start, wss, _, _ref,
  __slice = [].slice;

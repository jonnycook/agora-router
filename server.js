...
var OPEN, WebSocketServer, addDownServer, app, bodyParser, cbsForUser, connection, count, downServers, env, express, gatewayByUserId, gatewayForUser, gatewayMessage, gatewayServer, gatewayServers, id, mysql, num, removeDownServer, request, send, serverId, start, wss, _, _ref,
  __slice = [].slice;
